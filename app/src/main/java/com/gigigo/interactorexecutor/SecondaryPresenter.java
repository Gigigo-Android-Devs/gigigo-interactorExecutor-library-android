...
public class SecondaryPresenter extends Presenter<SecondaryView> {
  ...
  public SecondaryPresenter(GenericViewInjector viewInjector) {
    super(viewInjector);
  ...
  @Override public void onViewAttached() {
    getView().initUiForSecondaryView();
  ...
  public void load() {
    ...
    new InteractorExecution<>(interactor).result(new InteractorResult<Boolean>() {
      ...
      @Override public void onResult(Boolean result) {
        ...
        getView().concat(" async onSuccess ");
